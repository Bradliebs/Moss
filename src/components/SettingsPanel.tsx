...
export function SettingsPanel({ onClose }: { onClose: () => void }): React.ReactElement {
  ...
  return (
    <div className="fixed inset-0 z-10 flex justify-end bg-black/50">
      <div className="flex h-full w-[28rem] max-w-full flex-col border-l border-neutral-800 bg-neutral-950">
        ...
        <div className="min-h-0 flex-1 space-y-6 overflow-y-auto px-4 py-4 text-sm">
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Provider</h3>
            <label className="block">
              <span className="mb-1 block text-neutral-400">Preset</span>
              <select
            ...
            <label className="block">
              <span className="mb-1 block text-neutral-400">Base URL</span>
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1"
            ...
            <label className="block">
              <span className="mb-1 block text-neutral-400">API key (optional)</span>
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1"
                type="password"
                placeholder="API key"
            ...
            <label className="block">
              <span className="mb-1 block text-neutral-400">Model</span>
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Tools</h3>
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Custom instructions</h3>
            <textarea
              className="h-24 w-full resize-y rounded bg-neutral-800 px-2 py-1"
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Speech-to-text</h3>
            <label className="block">
              <span className="mb-1 block text-neutral-400">Transcription base URL (optional)</span>
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1"
            ...
            <label className="block">
              <span className="mb-1 block text-neutral-400">Transcription model</span>
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1"
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Context window</h3>
            <label className="block">
              <span className="mb-1 block text-neutral-400">Token limit (optional)</span>
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1"
                type="number"
                min={0}
          ...
          <section className="space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">MCP servers</h3>
              <button className="text-xs text-neutral-400 hover:text-neutral-100" onClick={() => void refreshMcp()}>
                Refresh
              </button>
            </div>
            {mcp.length === 0 ? (
              <p className="text-xs text-neutral-500">No MCP servers configured or connected.</p>
            ) : (
              <ul className="space-y-1">
                {mcp.map((s) => (
                  <li key={s.id} className="flex items-center justify-between gap-2 rounded bg-neutral-900 px-2 py-1">
                    <label className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        checked={s.enabled}
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-xs ${s.connected ? "text-green-400" : "text-neutral-500"}`}
            ...
            <div className="space-y-1 rounded bg-neutral-900 px-2 py-2">
              <select
              ...
              <input
                className="w-full rounded bg-neutral-800 px-2 py-1 text-xs disabled:opacity-50"
              ...
              <div className="flex gap-1">
                <button
                  className="flex-1 rounded bg-neutral-700 px-2 py-1 text-xs hover:bg-neutral-600 disabled:opacity-50"
                  disabled={
                    !newId.trim() ||
          ...
          <section className="space-y-2">
            <h3 className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Workspace</h3>
            <div className="flex items-center gap-2">
        ...
        {status ? (
          <footer className="border-t border-neutral-800 px-4 py-2 text-xs text-neutral-400">{status}</footer>
        ) : null}
      </div>
    </div>
  );
